        ...
        <div className="flex flex-col justify-center items-center bg-gray-900 px-8 py-12">
            ...
            >
                ...
                <div>
                    ...
                    <input id="password" type="password" name="password" required className="mt-2 block w-full rounded-md bg-white/5 px-3 py-2 text-base text-white outline-1 outline-white/10 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-500"/>
                </div>
